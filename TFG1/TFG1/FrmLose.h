...
namespace TFG1 {
	...
	/// Summary for FrmLose
	/// </summary>
	public ref class FrmLose : public System::Windows::Forms::Form
	{
	public:
		FrmLose(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(28, 75);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(253, 36);
			this->label1->TabIndex = 0;
			this->label1->Text = L"Perdiste papu :\'v";
			this->label1->TextAlign = System::Drawing::ContentAlignment::MiddleCenter;
			// 
			// btnTryAgain
			// 
			this->btnTryAgain->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Italic, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->btnTryAgain->Location = System::Drawing::Point(56, 126);
			this->btnTryAgain->Name = L"btnTryAgain";
			this->btnTryAgain->Size = System::Drawing::Size(192, 42);
			this->btnTryAgain->TabIndex = 2;
			this->btnTryAgain->Text = L"Intentalo de nuevo";
			this->btnTryAgain->UseVisualStyleBackColor = false;
			this->btnTryAgain->Click += gcnew System::EventHandler(this, &FrmLose::btnTryAgain_Click);
			// 
			// FrmLose
			// 
